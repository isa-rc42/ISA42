          ...
          <div class="rc42-roster-v16__grid rc42-roster-v16__grid--officers">
            ...
            <details class="rc42-roster-v16__card board-person-card">
              <summary class="board-person-summary">
                ...
                <div class="board-person-role">President</div>
            ...
            <details class="rc42-roster-v16__card board-person-card">
              <summary class="board-person-summary">
                ...
                <div class="board-person-role">Secretary / Treasurer</div>
          ...
          <div class="rc42-roster-v16__grid rc42-roster-v16__grid--members">
            ...
            <details class="rc42-roster-v16__card board-person-card">
              <summary class="board-person-summary">
                ...
                <div class="board-person-role">Board Member</div>
...
print("Updated people/index.qmd to use the restored institutional layout with `<details>` expansion.")
